...
<<<<<<< HEAD:code/modules/mob/living/carbon/monkey/punpun.dm
...
>>>>>>> f66ca34... Refactors monkeys into a species (#55614):code/modules/mob/living/carbon/human/monkey/monkey.dm
	. = ..()
